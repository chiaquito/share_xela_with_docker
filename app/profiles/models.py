...
class Profile(models.Model):
    ...
    adm0 = models.CharField(
        max_length=15, default="GUATEMALA", choices=adm0_CHOICES)
    adm1 = models.CharField(
        max_length=15, null=False, choices=DEPARTAMENTO_CHOICES)
    adm2 = models.CharField(
        max_length=30, null=False, choices=MUNICIPIO_CHOICES)
