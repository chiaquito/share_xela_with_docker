...
from prefecturas.models import (
    Prefectura, Departamento, Municipio, RegionClassed
    )
from prefecturas.load import (
    PrefecturaInstanceMaker, MunicipioInstanceMaker,
    DepartamentoInstanceMaker, RegionClassedInstanceMaker
)
